...
// 자바스크립트 객체 표기법
// 일반적으로 client-server간 통신에
// 데이터를 주고받을 떄 사용하는 데이터 형식
...
//        list.clear();
    ...
    public void func() {
        ...
        // intellij에서  롬복 라이브러리를 사용중이면 getter/setter 등을 쓸 수 있게 해주는 것
        acc.getAno();
        acc.setAno("002");
    }
}
